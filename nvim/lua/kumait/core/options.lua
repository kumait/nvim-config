...
opt.smartcase = true -- if you include mixed case in your search, assume you want case-sensitive search

opt.cursorline = true

-- turn on termguicolors for tokyonight colorscheme to wrok
